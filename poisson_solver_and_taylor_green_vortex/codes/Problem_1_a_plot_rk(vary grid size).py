...
#
plt.plot(iteration_list[0], rk_list[0], label = 'N = 10')
plt.plot(iteration_list[1], rk_list[1], label = 'N = 40')
plt.plot(iteration_list[2], rk_list[2], label = 'N = 80')

plt.title('Instantenous residual rk, versus the iteration number k for different grid sizes N')
...
plt.legend(loc = 'best')
plt.savefig('Instantenous residual rk, versus the iteration number k for different grid sizes N')
print rk_list[0]